<%-- 
    Document   : ModifyBook
    Created on : May 23, 2016, 7:24:22 PM
    Author     : Navneet
--%>
...
<html>
    ...
    <body>
        ...
        <h3 style="background: goldenrod">Modify Book Price </h3>
        <table>
            <tr>
        ...
        <span>Hi ${sessionScope.user.fname} </span>
            ...
            <input style="font-family: cursive;align-content: flex-end" type="submit" name="btn" value='Modify Book Price' ></br>
